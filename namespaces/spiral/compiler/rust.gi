...
#        Blanks(i),"    ", self(o.loc, i, is),"[iinit]=0;\n"),
    ...
    decl := meth(self,o,i,is)
        ...
        DoForAll(arrays, v -> Print(Blanks(i), "static mut ", v, ": ", self.(v.t.name)(v.t, [], i, is), " = [0.0", self.(v.t.t.name)(v.t.t, [], i, is), "; ", v.t.size ,"];\n"));
        self(o.cmd, i, is);
    end,
    ...
    TVoid  := (self, t, vars, i, is) >> Print("#[allow(unused_parens)]\npub fn ", self.infix(vars, ", ",i+is)),
